...
You can also use apktool to repackage decoded resources back to a binary APK/JAR. See the techniques @MASTG-TECH-0007 and @MASTG-TECH-0039 for more information and practical examples.
